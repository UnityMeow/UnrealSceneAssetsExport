...
Math::Matrix4 XM_CALLCONV GetTransformMatrix(const Math::Vector3& right, const Math::Vector3& up, const Math::Vector3& forward, const Math::Vector3& position)
{
	Math::Matrix4 target;
	target[0] = right;
	target[1] = up;
...
Math::Matrix4 XM_CALLCONV GetTransposedTransformMatrix(const Math::Vector3& right, const Math::Vector3& up, const Math::Vector3& forward, const Math::Vector3& position)
{
	Math::Matrix4 target;
	target[0] = right;
	target[1] = up;
...
Math::Vector4 XM_CALLCONV cross(const Math::Vector4& v1, const Math::Vector4& v2, const Math::Vector4& v3)
{
...
Math::Vector3 XM_CALLCONV cross(const Math::Vector3& v1, const Math::Vector3& v2)
{
	XMVECTOR& V1 = (XMVECTOR&)v1;
	XMVECTOR& V2 = (XMVECTOR&)v2;
...
Math::Vector4 XM_CALLCONV normalize(const Math::Vector4& v)
{
...
Math::Vector3 XM_CALLCONV normalize(const Math::Vector3& v)
{
	XMVECTOR& V = (XMVECTOR&)v;
...
Math::Matrix4 XM_CALLCONV GetInverseTransformMatrix(const Math::Vector3& right, const Math::Vector3& up, const Math::Vector3& forward, const Math::Vector3& position)
{
